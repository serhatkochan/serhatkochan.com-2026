...
export const travelPhotos = [
  ...
  { src: img3, alt: 'Seyahat fotoğrafı 3', width: 320, height: 356 },
  { src: img4, alt: 'Seyahat fotoğrafı 4', width: 320, height: 356 },
  { src: img5, alt: 'Seyahat fotoğrafı 5', width: 320, height: 356 },
  { src: img6, alt: 'Seyahat fotoğrafı 6', width: 320, height: 356 },
  { src: img7, alt: 'Seyahat fotoğrafı 7', width: 320, height: 356 },
  { src: img8, alt: 'Seyahat fotoğrafı 8', width: 320, height: 356 },
  { src: img9, alt: 'Seyahat fotoğrafı 9', width: 320, height: 356 },
  { src: img10, alt: 'Seyahat fotoğrafı 10', width: 320, height: 356 },
  { src: img11, alt: 'Seyahat fotoğrafı 11', width: 320, height: 356 },
  { src: img12, alt: 'Seyahat fotoğrafı 12', width: 320, height: 356 },
  { src: img13, alt: 'Seyahat fotoğrafı 13', width: 320, height: 356 },
  { src: img14, alt: 'Seyahat fotoğrafı 14', width: 320, height: 356 },
  { src: img15, alt: 'Seyahat fotoğrafı 15', width: 320, height: 356 },
  { src: img16, alt: 'Seyahat fotoğrafı 16', width: 320, height: 356 },
  { src: img17, alt: 'Seyahat fotoğrafı 17', width: 320, height: 356 },
  { src: img18, alt: 'Seyahat fotoğrafı 18', width: 320, height: 356 },
  { src: img19, alt: 'Seyahat fotoğrafı 19', width: 320, height: 356 },
  { src: img20, alt: 'Seyahat fotoğrafı 20', width: 320, height: 356 },
  { src: img21, alt: 'Seyahat fotoğrafı 21', width: 320, height: 356 },
  { src: img22, alt: 'Seyahat fotoğrafı 22', width: 320, height: 356 },
